...
import { Heading, Text, Flex, Badge } from "@chakra-ui/react";
const Profile = () => {
        ...
        >
          <div className="border rounded p-3 position-relative mb-2 bg-white">
            ...
            <div className="text-center">
              <div className="mt-2">
                <Text m="0" fontSize="xl" color="orange.500">
                  About:{" "}
                  <Text as="span" color="black">
                    {data.description === "" ? "N/A" : data.description}
                  </Text>
                </Text>
              </div>
              <div className="mt-2">
              ...
              <a href={data.location}>
                <p
                  className="fs-5 fw-normal mt-3"
                  style={{ cursor: "pointer" }}
                >
                  Find on Map <BsPinMapFill className="fs-4 d-inline" />
                </p>
              </a>
            </div>
            <Badge
